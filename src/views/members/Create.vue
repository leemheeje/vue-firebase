    ...
    <div class="innerWrap">
        <roundbox>
            ...
            <div class="reserFormArea MT30">
                <div class="row">
                    <div class="col8">
                        <forminput label="제목" required="true" v-model="pf_title" type="text"></forminput>
                    </div>
                </div>
                <div class="row MT30">
                    <div class="col8">
                        <forminput label="설명" required="true" v-model="pf_intro" formType="textarea"></forminput>
                    </div>
                </div>
                <div class="row MT30">
                    <div class="col8">
            ...
            <div class="btnsWrap MT50 TXTC">
                <btn href="javascript:;" @eventBus_click="locFnPortFolioUpdate" class="blue">등록하기</btn>
